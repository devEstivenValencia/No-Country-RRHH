...
export function encryptData(encrypterLocal: cipher.BlockCipher,dataToEncrypt: string): string
{
...
export function decryptData(decrypterLocal: cipher.BlockCipher, dataToDecrypt: string): any
{
